...
package com.alibaba.intellij.plugin.webx.model.spring;

import com.alibaba.intellij.plugin.webx.util.SpringExtConstant;
...
@Namespace(SpringExtConstant.BEANS_NAMESPACE_URI)
