...
public interface ResourceBundleLoader {
     ...
     *
     * <p>
     * 注意, 此处的参数为文件名, 区别于bundle的名称, <code>ResourceBundleFactory</code>必须在调用此方法前, 将bundle的名称转换成文件名.
     * 例如, bundle名为baseName_langauge_country, 则文件名可能是baseName_language_country.xml.
     * </p>
     *
