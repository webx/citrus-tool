 ...
 * <li>如果对象是字符串, 则试着把它转换成字符串名称所代表的<code>Enum</code>. 如果成功, 则返回.</li>
 * <li>试着将对象转换成<code>Enum.getUnderlyingClass</code>类型, 如果成功, 则返回对应的
 * <code>Enum</code>.</li>
...
public class EnumConverter implements Converter {
    public Object convert(Object value, ConvertChain chain) {
        ...
        try {
            Object enumValue = chain.getConvertManager().asTypeWithoutDefaultValue(Enum.getUnderlyingClass(targetType),
                                                                                   value);
