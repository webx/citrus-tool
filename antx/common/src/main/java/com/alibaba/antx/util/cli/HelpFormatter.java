...
public class HelpFormatter {
    ...
    protected StringBuffer renderOptions(StringBuffer sb, int width, Options options, int leftPad,
        ...
        for (Iterator i = optList.iterator(); i.hasNext();) {
            ...
            max = (optBuf.length() > max) ? optBuf.length()
                                          : max;
        }
    ...
    /**
     * Finds the next text wrap position after <code>startPos</code> for the text in
     * <code>sb</code> with the column width <code>width</code>. The wrap point is the last
     * postion before startPos+width having a whitespace character (space, \n, \r).
     *
