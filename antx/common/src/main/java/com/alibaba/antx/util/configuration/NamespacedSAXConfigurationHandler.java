...
/**
 * A SAXConfigurationHandler helps build Configurations out of sax events, including namespace
 * information.
 *
...
public class NamespacedSAXConfigurationHandler extends SAXConfigurationHandler {
    ...
    /**
     * Create a new <code>DefaultConfiguration</code> with the specified local name, namespace, and
     * location.
     *
     * @param localName a <code>String</code> value
     * @param namespaceURI a <code>String</code> value
    ...
    protected DefaultConfiguration createConfiguration(final String localName,
        final String namespaceURI, final Location location) {
    ...
    public void startElement(final String namespaceURI, final String localName,
        ...
        final DefaultConfiguration configuration = createConfiguration(localName, namespaceURI,
                getLocation());
        ...
        for (int i = 0; i < attributes.getLength(); i++) {
            if (attributes.getQName(i).startsWith("xmlns")) {
                ...
                componentAttr.addAttribute(attributes.getURI(i), attributes.getLocalName(i),
